    ...
    <div className="min-h-screen flex flex-col">
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="font-bold text-xl">QuizMaster</div>
          <ModeToggle />
        </div>
      </header>
          ...
          <Card className="backdrop-blur-sm bg-card/50 border shadow-md hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <li>Manage your student roster and quiz assignments</li>
                <li>Get insights with interactive charts and reports</li>
              </ul>
            </CardContent>
            <CardFooter>
