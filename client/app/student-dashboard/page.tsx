...
import { Search, BookOpen, BarChart3, LogOut, Menu, X, Clock } from "lucide-react"
...
const availableQuizzes = [
  { id: 1, title: "Math Fundamentals", questions: 10, timeLimit: "30 min", dueDate: "2023-10-30" },
  { id: 2, title: "Science Quiz", questions: 15, timeLimit: "45 min", dueDate: "2023-11-05" },
  { id: 3, title: "History Test", questions: 20, timeLimit: "60 min", dueDate: "2023-11-10" },
]

const completedQuizzes = [
  { id: 1, title: "English Grammar", questions: 12, score: 85, date: "2023-09-28" },
  { id: 2, title: "Geography Challenge", questions: 15, score: 92, date: "2023-09-20" },
  { id: 3, title: "Biology Basics", questions: 10, score: 78, date: "2023-09-15" },
]
          ...
          >
            <div className="flex flex-col h-full">
              ...
              <div className="flex flex-col gap-1 p-4">
                ...
                <Link href="/student-dashboard/results" onClick={() => setMobileMenuOpen(false)}>
                  <Button variant="ghost" className="w-full justify-start gap-2">
                    <BarChart3 className="h-4 w-4" />
                    Results
                  </Button>
                        ...
                        <TableBody>
                          {completedQuizzes.map((quiz) => (
                            <TableRow key={quiz.id}>
                              ...
                              <TableCell>
                                <Badge
                                  variant={quiz.score >= 90 ? "success" : quiz.score >= 70 ? "default" : "destructive"}
                                >
                                  {quiz.score}%
                                </Badge>
                              </TableCell>
